...
namespace Discord.API.Gateways
{
    internal static class EventNames
    {
        ...
        public const string CHANNEL_RECIPIENT_ADD = "CHANNEL_RECIPIENT_ADD";
        public const string CHANNEL_RECIPIENT_REMOVE = "CHANNEL_RECIPIENT_REMOVE";
        ...
        public const string GUILD_MEMBERS_CHUNK = "GUILD_MEMBERS_CHUNK";
