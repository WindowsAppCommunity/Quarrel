...
namespace Discord.API.Gateways
{
    internal partial class Gateway
    {
        ...
        public Gateway(GatewayConfig config,
            ...
            Action<JsonReactionUpdated> messageReactionAdded,
            Action<JsonReactionUpdated> messageReactionRemoved,
            Action<JsonReactionRemoveAll> messageReactionRemovedAll,
