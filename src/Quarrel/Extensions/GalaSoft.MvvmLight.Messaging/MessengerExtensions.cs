...
namespace GalaSoft.MvvmLight.Messaging
{
    ...
    public static class MessengerExtensions
    {
        ...
        [Pure, CanBeNull]
        public static TResult Request<TMessage, TResult>([NotNull] this IMessenger messenger) where TMessage : RequestMessageBase<TResult>, new()
        {
        ...
        [Pure, CanBeNull]
        public static TResult Request<TMessage, TResult>([NotNull] this IMessenger messenger, TMessage message) where TMessage : RequestMessageBase<TResult>
        {
            messenger.Send(message);
            if (!message.ResponseReceived) throw new InvalidOperationException("No response was received for the message");
            return message.Result;
