...
namespace Quarrel.Services.Cache.Runtime
{
    ...
    public interface IRuntimeCacheService
    {
        ...
        [MustUseReturnValue]
        T TryGetValue<T>([CanBeNull] string key, [CanBeNull] string scope = null) where T : class;
        ...
        /// <param name="scope">The optional scope of the item to look for</param>
        [MustUseReturnValue]
        T TryGetValue<T>([NotNull] string key, [NotNull] Func<T> producer, [CanBeNull] string scope = null) where T : class;
        ...
        /// <param name="scope">The optional scope of the item to look for</param>
        [MustUseReturnValue]
        Task<T> TryGetValueAsync<T>([NotNull] string key, [NotNull] Func<Task<T>> producer, [CanBeNull] string scope = null) where T : class;
        ...
        IReadOnlyList<T> TryGetValues<T>([CanBeNull] string scope = null) where T : class;
        ...
        void SetValue<T>([NotNull] string key, [NotNull] T value, [CanBeNull] string scope = null) where T : class;
