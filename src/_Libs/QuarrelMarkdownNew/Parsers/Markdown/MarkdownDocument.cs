...
namespace Microsoft.Toolkit.Parsers.Markdown
{
    ...
    public class MarkdownDocument : MarkdownBlock
    {
        ...
        /// <summary>
        /// A list of bracketed specific schemes.
        /// </summary>
        public static List<string> BracketSchemes { get; private set; } = new List<string>()
        {
            "http://",
            "https://",
            "ftp://",
        ...
        /// Gets or sets the dictionary of channel ids to channels.
        /// </summary>
        public IDictionary<string, (string Name, int Colour)> Roles { get; set; }
        ...
        internal static List<MarkdownBlock> Parse(string markdown, int start, int end, int quoteDepth, out int actualEnd)
        {
            ...
            while (startOfLine < end)
            {
                ...
                else
                {
                    ...
                    */
                    if (lineStartsNewParagraph || true)
                    {
