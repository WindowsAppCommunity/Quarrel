...
using Microsoft.Toolkit.Uwp.UI.Controls.Quarrel.Markdown.Render;
using Microsoft.Toolkit.Uwp.UI.Helpers.Quarrel;
...
namespace Microsoft.Toolkit.Uwp.UI.Controls.Quarrel
{
    /// <summary>
    ...
    public partial class MarkdownTextBlock
    {
        ...
        /// <summary>
        /// Gets the dependency property for <see cref="Users"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the mentioned channels.
        /// </summary>
        public IDictionary<string, string> Channels
        {
            get { return (IDictionary<string, string>)GetValue(ChannelsProperty); }
            set { SetValue(ChannelsProperty, value); }
        }

        /// <summary>
        /// Gets or sets the mentioned roles.
        /// </summary>
        public IDictionary<string, (string, int)> Roles
        {
            get { return (IDictionary<string, (string, int)>)GetValue(RolesProperty); }
