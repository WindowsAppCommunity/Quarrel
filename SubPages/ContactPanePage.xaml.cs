    ...
    public sealed partial class ContactPanePage : Page
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            DMChannelID = LocalState.DMs
                              ?.FirstOrDefault(dm => dm.Value?.Type == 1 && dm.Value.Users.FirstOrDefault()?.Id == userID).Value?.Id ??
        ...
        {
            if (_messageStacker == null || _messageStacker.ItemsUpdatingScrollMode != ItemsUpdatingScrollMode.KeepLastItemInView) return;
        ...
        public void AddMessages(Position position, bool scroll, List<MessageContainer> messages, bool showNewMessageIndicator)
        {
            ...
            await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, async () =>
                {
                    ...
                    {
                        if (App.IsFocused)
                            App.MarkMessageAsRead(message.Id, App.CurrentChannelId);
                        else
                            App.ReadWhenFocused(message.Id, App.CurrentChannelId, App.CurrentGuildId);
                    }
