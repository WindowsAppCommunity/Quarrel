namespace OpusDemo
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Select an input and output device. Once you click \"Start\" audio will be captured " +
    "from your micrphone, encoded and decoded using Opus and played through the outpu" +
    "t device.";
            // 
            // label2
            // 
