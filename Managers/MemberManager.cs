...
namespace Discord_UWP.Managers
{
    class MemberManager
    {
        ...
        public static HoistRole GetRole(string roleid, string guildid, int everyonecounter)
        {
            ...
            else
            {
                ...
                if (roleid == null || !LocalState.Guilds[guildid].roles[roleid].Hoist)
                {
                    ...
                    role = new HoistRole(null, 0, App.GetString("/Main/Everyone"), everyonecounter, (SolidColorBrush)App.Current.Resources["Foreground"]);
